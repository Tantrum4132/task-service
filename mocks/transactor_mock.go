...
// Source: github.com/Tantrum4132/task-service/internal/service (interfaces: Transactor)
...
func (m *MockTransactor) WithinTransaction(arg0 context.Context, arg1 func(repository.DBEngine) error) error {
	m.ctrl.T.Helper()
